...
SPEAKER_LINKS: List[Tuple[str, str]] = [
    ...
    (
        "data/beamsearch/aug_beams_val_seen.json",
        "https://dl.dropbox.com/s/1o6xmjjv74mq8f8/beams_val_seen.json",
    ),
    (
        "data/task/aug+R2R_val_unseen.json",
...
FGR2R_TASK_LINKS = [
    (
        "data/task/FGR2R_test.json",
        "https://raw.githubusercontent.com/YicongHong/Fine-Grained-R2R/master/data/FGR2R_test.json",
    ),
    (
        "data/task/FGR2R_train.json",
        "https://raw.githubusercontent.com/YicongHong/Fine-Grained-R2R/master/data/FGR2R_train.json",
    ),
    (
        "data/task/FGR2R_val_seen.json",
        "https://raw.githubusercontent.com/YicongHong/Fine-Grained-R2R/master/data/FGR2R_val_seen.json",
    ),
    (
        "data/task/FGR2R_val_unseen.json",
        "https://raw.githubusercontent.com/YicongHong/Fine-Grained-R2R/master/data/FGR2R_val_unseen.json",
    ),
]
...
if __name__ == "__main__":
    ...
    if download_all or args.task:
        for path, url in TASK_LINKS:
            _download_url_to_file(url, path)
        for path, url in FGR2R_TASK_LINKS:
            _download_url_to_file(url, path)
